...
class AnalyseBenchmark:
    ...
    def __init__(self, fichier_csv=RESULTS_DIR / "resultats_benchmark.csv"):
    ...
    def plot_temps_vs_dimension(self):
        ...
        plt.savefig(RESULTS_DIR / 'benchmark_temps.png', dpi=150)
    ...
    def plot_boite_temps(self):
        ...
        plt.tight_layout()
        RESULTS_DIR.mkdir(parents=True, exist_ok=True)
        plt.savefig(RESULTS_DIR / 'benchmark_boites.png', dpi=150)
    ...
    def plot_cout_vs_temps(self):
        ...
        plt.tight_layout()
        RESULTS_DIR.mkdir(parents=True, exist_ok=True)
        plt.savefig(RESULTS_DIR / 'benchmark_cout_vs_temps.png', dpi=150)
...
def main():
    ...
    analyse = AnalyseBenchmark(RESULTS_DIR / "resultats_benchmark.csv")
